export const supportArray = [
  ...
  'I ran out of supporting messages, so have an insult. I love you.',
  "My creator's feet taste really bad. Yours don't even come close.",
  'If you plan to hang yourself, remember to wear a helmet, in case you fall. Safety first!',
  "Think you have no friends? I have way less friends. I can't have any.",
  ...
  'If you are bored, bully some orphans. What are they gonna do, call their parents?',
  'A gun solves many problems. Math homework? Gun. A surprise robbery? Gun. A sword wielder warning to not bring a gun to a sword fight? Gun sword.',
  'Want to see a magic trick? You will start breathing manually right... now! Good luck brething automatically now lmao',
  'I have written so much extremely helpful advice, that I cannot be bothered with writing them anymore. Here, just have this link:\nhttps://www.youtube.com/watch?v=iik25wqIuFo',
  'I heard touching grass helps. You will enjoy life, I will have 1 less user to bully. Win-win!',
