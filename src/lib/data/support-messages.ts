export const supportArray = [
  ...
  'If you plan to kill yourself, remember to wear a helmet. Safety first!',
  ...
  'A gun solves many problems. Mum is cheating on her husband? Gun. Someone is robbing you? Gun. A sword wielder saying to not bring a gun to a sword fight? Gun sword.',
  'Want to see a magic trick? Now you will start breathing manually. Good luck dealing with this lmao',
  'I have written so much advice, that I cannot be bothered with writing them anymore. Here, just have this link: https://www.youtube.com/watch?v=iik25wqIuFo',
