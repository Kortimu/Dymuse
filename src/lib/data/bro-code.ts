export const broCode = [
  ...
  'A Bro always maintains a minimum of one urinal gap between Bros',
  'A Bro is never vegan',
  "Bros never talk about their Bro's wife in a sexual way",
  'A Bro must always accept a request to act as wingman for another bro',
  ...
  'If a Bro gets dumped, it is up to his fellow Bros to take him paintballing and get him drunk to forget',
  'A Bro only comments on another Bros appearance if it improves his odds of getting laid',
  'When the girlfriend of a Bro comes and asks where said Bro is, YOU KNOW NOTHING.',
