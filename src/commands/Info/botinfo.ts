...
@ApplyOptions<CommandOptions>({
    ...
    detailedDescription: "A command that provides the user with additional information about the bot, such as the creation date, features and more.",
})
    ...
    public async messageRun(message: Message) {
        ...
        return send(message, {
            embeds: [
                ...
                .setDescription(`${bot} is a bot made for the Dylan, the owner of \`The Shag Syndicate\`. It has:\n- Multiple fun and useful commands\n- Features tailored to the server\nAnd more!`)
            ]
        })
    }
}